...
./run-qt-tests.sh                # 3207 assertions + startup checks
...
commit. Current state: **3207 passed, 0 failed**, startup diagnostics ok. The full suite is also clean under AddressSanitizer (`make -f Makefile.qt.asan`).
