...
- **`EPHEMERIS_SERVER_PLAN.md`** and **`EPHEMERIS_CLIENT_PLAN.md`** — the
  ...
  group skips itself with a printed reason. Its six gates
  (`tools/ephsrv-golden.sh`, `-soak.sh`, `-cache.sh`, `-bench.sh`,
  `-robust.sh`, `-tls.sh`) are
