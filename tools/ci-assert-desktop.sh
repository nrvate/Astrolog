...
#
# They are generated by the Makefile's install target. (A second
# generator, tools/package-stage.sh, staged the same files for the .deb
# and .rpm; both went with the Linux packages on 2026-09-05.)
set -eu
