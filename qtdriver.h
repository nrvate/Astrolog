...
// TextClickAtPtQt and TextHoverAtPtQt take a point in canvas pixels,
// exactly what the canvas's mouse handlers are handed; the setters behind
// them take the word itself, which is what the suite drives. On an aspect
// list's header row a click sorts instead of pinning, and fShift says a
