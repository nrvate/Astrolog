...
extern char *Dignify P((OBJ, SIGN));
...
extern OBJ ObjOrbit P((OBJ));
extern int ObjMoons P((OBJ));
extern real RObjDiam P((OBJ));
...
extern void SetObjGlyphNoneCore P((OBJ));
extern flag SetObjDisp P((OBJ, CONST char *));
extern flag FCloneSzCore P((CONST char *, char **, flag));
extern char *SzClone P((CONST char *));
...
extern void InputString P((CONST char *, char *, int));
...
extern void PrintAspectsToPoint P((real, int, real, CONST char *));
...
extern flag FEndGif P((flag));
extern flag FGifPump P((int, flag *));
extern int NGifWritten P((void));
extern int NGifThreads P((void));
extern int NGifThreadMax P((void));
extern void (*pfnGifFrameHook) P((int));
extern flag fGifWorkerHold;
...
extern CI *PciAnimate P((void));
extern void AnimateCommit P((void));
extern flag FAnimateRotates P((void));
extern void StepAnimateCi P((CI *, int, int));
extern int NGifFrameCount P((CONST GA *));
extern flag FGenerateGif P((CONST GA *));
